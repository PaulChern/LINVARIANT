Function GetEOnSiteJij(x0, y0, z0, Fields, e0ij) Result(EOnSite)
  ...
  EOnSiteJijhf = &
    EOnSiteJijhf &
    +CoeffJijhf(2)*Fields(1,2,x0,y0,z0)*Fields(1,2,x0,y0,z1) &
    +CoeffJijhf(2)*Fields(1,2,x0,y0,z0)*Fields(1,2,x0,y0,zi1) &
    +CoeffJijhf(2)*Fields(1,2,x0,y0,z0)*Fields(1,2,x0,y1,z0) &
    +CoeffJijhf(4)*Fields(1,2,x0,y0,z0)*Fields(1,2,x0,y1,z1) &
    +CoeffJijhf(4)*Fields(1,2,x0,y0,z0)*Fields(1,2,x0,y1,zi1) &
    +CoeffJijhf(2)*Fields(1,2,x0,y0,z0)*Fields(1,2,x0,yi1,z0) &
    +CoeffJijhf(4)*Fields(1,2,x0,y0,z0)*Fields(1,2,x0,yi1,z1) &
    +CoeffJijhf(4)*Fields(1,2,x0,y0,z0)*Fields(1,2,x0,yi1,zi1) &
    +CoeffJijhf(1)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,y0,z0) &
    +CoeffJijhf(3)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,y0,z1) &
    +CoeffJijhf(3)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,y0,zi1) &
    +CoeffJijhf(3)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,y1,z0) &
    +CoeffJijhf(5)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,y1,z1) &
    +CoeffJijhf(5)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,y1,zi1) &
    +CoeffJijhf(3)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,yi1,z0) &
    +CoeffJijhf(5)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,yi1,z1) &
    +CoeffJijhf(5)*Fields(1,2,x0,y0,z0)*Fields(1,2,x1,yi1,zi1) &
    +CoeffJijhf(1)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,y0,z0) &
    +CoeffJijhf(3)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,y0,z1) &
    +CoeffJijhf(3)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,y0,zi1) &
    +CoeffJijhf(3)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,y1,z0) &
    +CoeffJijhf(5)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,y1,z1) &
    +CoeffJijhf(5)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,y1,zi1) &
    +CoeffJijhf(3)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,yi1,z0) &
    +CoeffJijhf(5)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,yi1,z1) &
    +CoeffJijhf(5)*Fields(1,2,x0,y0,z0)*Fields(1,2,xi1,yi1,zi1) &
    +CoeffJijhf(6)*Fields(1,2,x1,y1,z0)*Fields(2,2,x0,y0,z0) &
    +CoeffJijhf(7)*Fields(1,2,x1,y1,z1)*Fields(2,2,x0,y0,z0) &
    +CoeffJijhf(7)*Fields(1,2,x1,y1,zi1)*Fields(2,2,x0,y0,z0) &
    -(CoeffJijhf(6)*Fields(1,2,x1,yi1,z0)*Fields(2,2,x0,y0,z0)) &
    -(CoeffJijhf(7)*Fields(1,2,x1,yi1,z1)*Fields(2,2,x0,y0,z0)) &
    -(CoeffJijhf(7)*Fields(1,2,x1,yi1,zi1)*Fields(2,2,x0,y0,z0)) &
    -(CoeffJijhf(6)*Fields(1,2,xi1,y1,z0)*Fields(2,2,x0,y0,z0)) &
    -(CoeffJijhf(7)*Fields(1,2,xi1,y1,z1)*Fields(2,2,x0,y0,z0)) &
    -(CoeffJijhf(7)*Fields(1,2,xi1,y1,zi1)*Fields(2,2,x0,y0,z0)) &
    +CoeffJijhf(6)*Fields(1,2,xi1,yi1,z0)*Fields(2,2,x0,y0,z0) &
    +CoeffJijhf(7)*Fields(1,2,xi1,yi1,z1)*Fields(2,2,x0,y0,z0) &
    +CoeffJijhf(7)*Fields(1,2,xi1,yi1,zi1)*Fields(2,2,x0,y0,z0) &
    +CoeffJijhf(2)*Fields(2,2,x0,y0,z0)*Fields(2,2,x0,y0,z1) &
    +CoeffJijhf(2)*Fields(2,2,x0,y0,z0)*Fields(2,2,x0,y0,zi1) &
    +CoeffJijhf(1)*Fields(2,2,x0,y0,z0)*Fields(2,2,x0,y1,z0) &
    +CoeffJijhf(3)*Fields(2,2,x0,y0,z0)*Fields(2,2,x0,y1,z1) &
    +CoeffJijhf(3)*Fields(2,2,x0,y0,z0)*Fields(2,2,x0,y1,zi1) &
    +CoeffJijhf(1)*Fields(2,2,x0,y0,z0)*Fields(2,2,x0,yi1,z0) &
    +CoeffJijhf(3)*Fields(2,2,x0,y0,z0)*Fields(2,2,x0,yi1,z1) &
    +CoeffJijhf(3)*Fields(2,2,x0,y0,z0)*Fields(2,2,x0,yi1,zi1) &
    +CoeffJijhf(2)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,y0,z0) &
    +CoeffJijhf(4)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,y0,z1) &
    +CoeffJijhf(4)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,y0,zi1) &
    +CoeffJijhf(6)*Fields(1,2,x0,y0,z0)*Fields(2,2,x1,y1,z0) &
    +CoeffJijhf(3)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,y1,z0) &
    +CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(2,2,x1,y1,z1) &
    +CoeffJijhf(5)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,y1,z1) &
    +CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(2,2,x1,y1,zi1) &
    +CoeffJijhf(5)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,y1,zi1) &
    -(CoeffJijhf(6)*Fields(1,2,x0,y0,z0)*Fields(2,2,x1,yi1,z0)) &
    +CoeffJijhf(3)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,yi1,z0) &
    -(CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(2,2,x1,yi1,z1)) &
    +CoeffJijhf(5)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,yi1,z1) &
    -(CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(2,2,x1,yi1,zi1)) &
    +CoeffJijhf(5)*Fields(2,2,x0,y0,z0)*Fields(2,2,x1,yi1,zi1) &
    +CoeffJijhf(2)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,y0,z0) &
    +CoeffJijhf(4)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,y0,z1) &
    +CoeffJijhf(4)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,y0,zi1) &
    -(CoeffJijhf(6)*Fields(1,2,x0,y0,z0)*Fields(2,2,xi1,y1,z0)) &
    +CoeffJijhf(3)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,y1,z0) &
    -(CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(2,2,xi1,y1,z1)) &
    +CoeffJijhf(5)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,y1,z1) &
    -(CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(2,2,xi1,y1,zi1)) &
    +CoeffJijhf(5)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,y1,zi1) &
    +CoeffJijhf(6)*Fields(1,2,x0,y0,z0)*Fields(2,2,xi1,yi1,z0) &
    +CoeffJijhf(3)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,yi1,z0) &
    +CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(2,2,xi1,yi1,z1) &
    +CoeffJijhf(5)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,yi1,z1) &
    +CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(2,2,xi1,yi1,zi1) &
    +CoeffJijhf(5)*Fields(2,2,x0,y0,z0)*Fields(2,2,xi1,yi1,zi1) &
    +CoeffJijhf(6)*Fields(1,2,x1,y0,z1)*Fields(3,2,x0,y0,z0) &
    -(CoeffJijhf(6)*Fields(1,2,x1,y0,zi1)*Fields(3,2,x0,y0,z0)) &
    +CoeffJijhf(7)*Fields(1,2,x1,y1,z1)*Fields(3,2,x0,y0,z0) &
    -(CoeffJijhf(7)*Fields(1,2,x1,y1,zi1)*Fields(3,2,x0,y0,z0)) &
    +CoeffJijhf(7)*Fields(1,2,x1,yi1,z1)*Fields(3,2,x0,y0,z0) &
    -(CoeffJijhf(7)*Fields(1,2,x1,yi1,zi1)*Fields(3,2,x0,y0,z0)) &
    -(CoeffJijhf(6)*Fields(1,2,xi1,y0,z1)*Fields(3,2,x0,y0,z0)) &
    +CoeffJijhf(6)*Fields(1,2,xi1,y0,zi1)*Fields(3,2,x0,y0,z0) &
    -(CoeffJijhf(7)*Fields(1,2,xi1,y1,z1)*Fields(3,2,x0,y0,z0)) &
    +CoeffJijhf(7)*Fields(1,2,xi1,y1,zi1)*Fields(3,2,x0,y0,z0) &
    -(CoeffJijhf(7)*Fields(1,2,xi1,yi1,z1)*Fields(3,2,x0,y0,z0)) &
    +CoeffJijhf(7)*Fields(1,2,xi1,yi1,zi1)*Fields(3,2,x0,y0,z0) &
    +CoeffJijhf(6)*Fields(2,2,x0,y1,z1)*Fields(3,2,x0,y0,z0) &
    -(CoeffJijhf(6)*Fields(2,2,x0,y1,zi1)*Fields(3,2,x0,y0,z0)) &
    -(CoeffJijhf(6)*Fields(2,2,x0,yi1,z1)*Fields(3,2,x0,y0,z0)) &
    +CoeffJijhf(6)*Fields(2,2,x0,yi1,zi1)*Fields(3,2,x0,y0,z0) &
    +CoeffJijhf(7)*Fields(2,2,x1,y1,z1)*Fields(3,2,x0,y0,z0) &
    -(CoeffJijhf(7)*Fields(2,2,x1,y1,zi1)*Fields(3,2,x0,y0,z0)) &
    -(CoeffJijhf(7)*Fields(2,2,x1,yi1,z1)*Fields(3,2,x0,y0,z0)) &
    +CoeffJijhf(7)*Fields(2,2,x1,yi1,zi1)*Fields(3,2,x0,y0,z0) &
    +CoeffJijhf(7)*Fields(2,2,xi1,y1,z1)*Fields(3,2,x0,y0,z0) &
    -(CoeffJijhf(7)*Fields(2,2,xi1,y1,zi1)*Fields(3,2,x0,y0,z0)) &
    -(CoeffJijhf(7)*Fields(2,2,xi1,yi1,z1)*Fields(3,2,x0,y0,z0)) &
    +CoeffJijhf(7)*Fields(2,2,xi1,yi1,zi1)*Fields(3,2,x0,y0,z0) &
    +CoeffJijhf(1)*Fields(3,2,x0,y0,z0)*Fields(3,2,x0,y0,z1) &
    +CoeffJijhf(1)*Fields(3,2,x0,y0,z0)*Fields(3,2,x0,y0,zi1) &
    +CoeffJijhf(2)*Fields(3,2,x0,y0,z0)*Fields(3,2,x0,y1,z0) &
    +CoeffJijhf(6)*Fields(2,2,x0,y0,z0)*Fields(3,2,x0,y1,z1) &
    +CoeffJijhf(3)*Fields(3,2,x0,y0,z0)*Fields(3,2,x0,y1,z1) &
    -(CoeffJijhf(6)*Fields(2,2,x0,y0,z0)*Fields(3,2,x0,y1,zi1)) &
    +CoeffJijhf(3)*Fields(3,2,x0,y0,z0)*Fields(3,2,x0,y1,zi1) &
    +CoeffJijhf(2)*Fields(3,2,x0,y0,z0)*Fields(3,2,x0,yi1,z0) &
    -(CoeffJijhf(6)*Fields(2,2,x0,y0,z0)*Fields(3,2,x0,yi1,z1)) &
    +CoeffJijhf(3)*Fields(3,2,x0,y0,z0)*Fields(3,2,x0,yi1,z1) &
    +CoeffJijhf(6)*Fields(2,2,x0,y0,z0)*Fields(3,2,x0,yi1,zi1) &
    +CoeffJijhf(3)*Fields(3,2,x0,y0,z0)*Fields(3,2,x0,yi1,zi1) &
    +CoeffJijhf(2)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,y0,z0) &
    +CoeffJijhf(6)*Fields(1,2,x0,y0,z0)*Fields(3,2,x1,y0,z1) &
    +CoeffJijhf(3)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,y0,z1) &
    -(CoeffJijhf(6)*Fields(1,2,x0,y0,z0)*Fields(3,2,x1,y0,zi1)) &
    +CoeffJijhf(3)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,y0,zi1) &
    +CoeffJijhf(4)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,y1,z0) &
    +CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(3,2,x1,y1,z1) &
    +CoeffJijhf(7)*Fields(2,2,x0,y0,z0)*Fields(3,2,x1,y1,z1) &
    +CoeffJijhf(5)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,y1,z1) &
    -(CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(3,2,x1,y1,zi1)) &
    -(CoeffJijhf(7)*Fields(2,2,x0,y0,z0)*Fields(3,2,x1,y1,zi1)) &
    +CoeffJijhf(5)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,y1,zi1) &
    +CoeffJijhf(4)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,yi1,z0) &
    +CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(3,2,x1,yi1,z1) &
    -(CoeffJijhf(7)*Fields(2,2,x0,y0,z0)*Fields(3,2,x1,yi1,z1)) &
    +CoeffJijhf(5)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,yi1,z1) &
    -(CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(3,2,x1,yi1,zi1)) &
    +CoeffJijhf(7)*Fields(2,2,x0,y0,z0)*Fields(3,2,x1,yi1,zi1) &
    +CoeffJijhf(5)*Fields(3,2,x0,y0,z0)*Fields(3,2,x1,yi1,zi1) &
    +CoeffJijhf(2)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,y0,z0) &
    -(CoeffJijhf(6)*Fields(1,2,x0,y0,z0)*Fields(3,2,xi1,y0,z1)) &
    +CoeffJijhf(3)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,y0,z1) &
    +CoeffJijhf(6)*Fields(1,2,x0,y0,z0)*Fields(3,2,xi1,y0,zi1) &
    +CoeffJijhf(3)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,y0,zi1) &
    +CoeffJijhf(4)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,y1,z0) &
    -(CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(3,2,xi1,y1,z1)) &
    +CoeffJijhf(7)*Fields(2,2,x0,y0,z0)*Fields(3,2,xi1,y1,z1) &
    +CoeffJijhf(5)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,y1,z1) &
    +CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(3,2,xi1,y1,zi1) &
    -(CoeffJijhf(7)*Fields(2,2,x0,y0,z0)*Fields(3,2,xi1,y1,zi1)) &
    +CoeffJijhf(5)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,y1,zi1) &
    +CoeffJijhf(4)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,yi1,z0) &
    -(CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(3,2,xi1,yi1,z1)) &
    -(CoeffJijhf(7)*Fields(2,2,x0,y0,z0)*Fields(3,2,xi1,yi1,z1)) &
    +CoeffJijhf(5)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,yi1,z1) &
    +CoeffJijhf(7)*Fields(1,2,x0,y0,z0)*Fields(3,2,xi1,yi1,zi1) &
    +CoeffJijhf(7)*Fields(2,2,x0,y0,z0)*Fields(3,2,xi1,yi1,zi1) &
    +CoeffJijhf(5)*Fields(3,2,x0,y0,z0)*Fields(3,2,xi1,yi1,zi1)
  
  EOnSite=EOnSiteJijsm+EOnSiteJijhf
  
End Function GetEOnSiteJij
