Function GetForcesJij(x0, y0, z0, Fields, e0ij) Result(Forces)
  ...
  Real*8              :: Forces(Max(FieldDim, 6), NumField+1)
  ...
  Forces=ForcesJijsm+ForcesJijhf
  
End Function GetForcesJij
