...
FortranMain[] := Module[{Fint, Fout},
  ...
  Fout = {{"Program main"},
          ...
          {Fint[1]},
          {Fint[1] <> "allocate(EwaldField(FieldDim,NumField,cgrid%n1,cgrid%n2,cgrid%n3))"},
...
FortranInputs[] := Module[{Fint, Fout},
  ...
  Fout = {{"Module Inputs"},
          ...
          {Fint[1] <> "!---------------------------------------------------------------------------------"},
          {Fint[1] <> "integer :: cgrid%n1              !< Number of cell repetitions in x direction"},
          {Fint[1] <> "integer :: cgrid%n2              !< Number of cell repetitions in y direction"},
          {Fint[1] <> "integer :: cgrid%n3              !< Number of cell repetitions in z direction"},
          {Fint[1]},
          {Fint[1] <> "!---------------------------------------------------------------------------------"},
          ...
          {Fint[5] <> "pos = scan(cache, '=')"},
          {Fint[5] <> "cache = trim(cache(pos+1:))"},
          {Fint[5] <> "read(cache, *, iostat=i_err) cgrid%n1, cgrid%n2, cgrid%n3"},
          {Fint[5] <> "if(i_err/=0) write(*,*) 'ERROR: Reading ',trim(keyword),' data',i_err"},
          {Fint[4] <> "case default"},
          ...
          {Fint[2] <> "Real*8                   :: e"},
          {Fint[2] <> "Real*8, Intent(inout)    :: Fields(FieldDim, NumField, cgrid%n1, cgrid%n2, cgrid%n3)"},
...
FortranOutputs[] := Module[{Fint, Fout},
  ...
  Fout = {{"Module Outputs "},
          ...
          {Fint[2] <> "Integer        :: ix, iy, iz, i, ifield"},
          {Fint[2] <> "Real*8         :: Fields(FieldDim, NumField, cgrid%n1, cgrid%n2, cgrid%n3)"},
          {Fint[2] <> "Real*8         :: dFieldsdt(FieldDim, NumField, cgrid%n1, cgrid%n2, cgrid%n3)"},
          ...
          {Fint[3]},
          {Fint[3] <> "do igrid = 1, cgrid%n3*cgrid%n2*cgrid%n1"},
          ...
          {Fint[5] <> "Observables(j, ifield) = Sum(Fields(j,ifield,:,:,:)**order)/(cgrid%n1*cgrid%n2*cgrid%n3)"},
          {Fint[4] <> "end do"},
...
LINVARIANTModule[DeltaFunctionList_?ListQ, OtherFunctionList_:{}, OptionsPattern[{"EwaldField"->True}]] := Module[{Fint, n, Fout, IncFuncBlock, DeltaHBlock, EwaldFieldBlock, EwaldFieldArg},
  ...
  EwaldFieldBlock = If[OptionValue["EwaldField"], {{Fint[2] <> " Real*8,  Intent(in) :: EwaldField(NumField, cgrid%n1, cgrid%n2, cgrid%n3, FieldDim)"}}, {}];
  ...
  Fout = Join[{{"Module LINVARIANT"},
    ...
    {{Fint[1]},
     ...
     {Fint[2] <> "Implicit none"}, 
     {Fint[2] <> "Real*8,  Intent(in)    :: Fields(FieldDim, NumField, cgrid%n1, cgrid%n2, cgrid%n3)"}, 
     ...
     {Fint[2] <> "Integer                :: ix, iy, iz"}, 
     {Fint[2]}, 
     {Fint[2] <> "GridDriftx = Sum(Fields(1,NumField,:,:,:))/(cgrid%n1*cgrid%n2*cgrid%n3)"}, 
     {Fint[2] <> "GridDrifty = Sum(Fields(2,NumField,:,:,:))/(cgrid%n1*cgrid%n2*cgrid%n3)"}, 
     {Fint[2] <> "GridDriftz = Sum(Fields(3,NumField,:,:,:))/(cgrid%n1*cgrid%n2*cgrid%n3)"}, 
     {Fint[2]}, 
     {Fint[2] <> "do iz = 1, cgrid%n3"}, 
     {Fint[3] <> "do iy = 1, cgrid%n2"}, 
     {Fint[4] <> "do ix = 1, cgrid%n1"}, 
     ...
     {Fint[2] <> "Implicit none"},
     {Fint[2] <> "Real*8,  Intent(in)    :: Fields(FieldDim, NumField, cgrid%n1, cgrid%n2, cgrid%n3)"},
     {Fint[2] <> "Real*8                 :: Fields1D(FieldDim*NumField*cgrid%n1*cgrid%n2*cgrid%n3)"},
     ...
     {Fint[7] <> "id = (iz-1)*cgrid%n2*cgrid%n1*NumField*FieldDim &"},
     {Fint[7] <> "+ (iy-1)*cgrid%n1*NumField*FieldDim &"},
     ...
     {Fint[2] <> "Implicit none"},
     {Fint[2] <> "Real*8,  Intent(in)    :: Fields1D(FieldDim*NumField*cgrid%n1*cgrid%n2*cgrid%n3)"},
     {Fint[2] <> "Real*8                 :: Fields(FieldDim,NumField,cgrid%n1,cgrid%n2,cgrid%n3)"},
     {Fint[2]},
     {Fint[2] <> "Fields = Reshape(Fields1D, (/FieldDim, NumField, cgrid%n1, cgrid%n2, cgrid%n3/))"},
     {Fint[2]},
     ...
     {Fint[2] <> "Implicit none"},
     {Fint[2] <> "Real*8,  Intent(in) :: dFieldsdt(FieldDim, NumField, cgrid%n1, cgrid%n2, cgrid%n3)"}, 
     {Fint[2] <> "Real*8,  Intent(in) :: de0ijdt(3,3)"}, 
     {Fint[2] <> "Real*8              :: TK, Ekin"}, 
     {Fint[2] <> "Integer             :: i, ifield, ix, iy, iz, TotalDim"}, 
     {Fint[2]}, 
     {Fint[2] <> "TotalDim = cgrid%n1*cgrid%n2*cgrid%n3*OnSiteDim + 6"}, 
     {Fint[2] <> "Ekin = GetEkin(dFieldsdt, de0ijdt)"}, 
     ...
     {Fint[2] <> "end do"}, 
     {Fint[2] <> "do i = 1, 6"}, 
     {Fint[3] <> "Ekin = Ekin + 0.5d0*cgrid%n1*cgrid%n2*cgrid%n3*mass(NumField+1)*mpme*detadt(i)**2"}, 
     {Fint[2] <> "end do"}, 
     {Fint[2]}, 
     ...
     {Fint[2]}, 
     {Fint[2] <> "TotalDim = cgrid%n1*cgrid%n2*cgrid%n3*OnSiteDim"}, 
     {Fint[2] <> "Ekin = GetEkin(dFieldsdt, de0ijdt)"}, 
