...
FortranMain[] := Module[{Fint, Fout},
  ...
  Fout = {{"Program main"},
          ...
          {Fint[4] <> "end if"},
          {Fint[4] <> "Call PTSwap(TempList, Fields, EwaldField, e0ij, dFieldsdt, de0ijdt, SIZE_CLUSTER, Replicas, PROCESS_RANK+1, ireplica)"},
          ...
          {Fint[5] <> "Call PTSwap(TempList, Fields, EwaldField, e0ij, dFieldsdt, de0ijdt, SIZE_CLUSTER, Replicas, PROCESS_RANK+1, istep)"},
          {Fint[5] <> "if(PROCESS_RANK == 0) then"},
