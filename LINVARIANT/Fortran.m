...
FortranMain[] := Module[{Fint, Fout},
  ...
  Fout = {{"Program main"},
          ...
          {Fint[5] <> "Call MCMCStep(istep, seed, Fields, EwaldField, e0ij, TempList(PROCESS_RANK+1), udamp, etadamp, dene)"},
          {Fint[4] <> "end do"},
          ...
          {Fint[2]},
          {Fint[2] <> "do istep = 1, NumSteps"},
          {Fint[3] <> "Call MCMCStep(istep, seed, Fields, EwaldField, e0ij, TempList(PROCESS_RANK+1), udamp, etadamp, dene)"},
          {Fint[3] <> "if((mod(istep,TapeRate).eq.0).and.(istep.gt.ThermoSteps)) then"},
          ...
          {Fint[4] <> "end if"},
          {Fint[4] <> "Call WriteBinary(ifileno+100*PROCESS_RANK, Fields, dFieldsdt, e0ij, de0ijdt)"},
          {Fint[3] <> "end if"},
